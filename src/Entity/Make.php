 ...
 * @ORM\Entity(repositoryClass="MajidMvulle\VehicleBundle\Repository\MakeRepository")
...
class Make
{
     ...
     * @var ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="MajidMvulle\VehicleBundle\Entity\Model", mappedBy="make")
     */
    protected $models;
